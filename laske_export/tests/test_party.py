...
@pytest.mark.parametrize("first_name, last_name, expected1, expected2, expected3, expected4", [
    (
        # Name
        None,
        None,
...
def test_party_from_contact_person_name(django_db_setup, contact_factory, first_name, last_name, expected1, expected2,
                                        expected3, expected4):
    contact = contact_factory(first_name=first_name, last_name=last_name, type=ContactType.PERSON)
...
def test_party_from_contact_person_name_with_care_of(django_db_setup, contact_factory, first_name, last_name, expected1,
...
def test_party_from_contact_person_name_with_long_care_of(django_db_setup, contact_factory, first_name, last_name,
...
@pytest.mark.django_db
@pytest.mark.parametrize("name, expected1, expected2, expected3, expected4", [
    (
        # Name
        None,
        # Expected
...
def test_party_from_contact_name(django_db_setup, contact_factory, name, expected1, expected2,
                                 expected3, expected4):
...
def test_party_from_contact_name_with_care_of(django_db_setup, contact_factory, name, expected1,
                                              expected2, expected3, expected4):
    contact = contact_factory(name=name, type=ContactType.BUSINESS,
                              care_of='Something random')
...
def test_party_from_contact_person_with_long_care_of(django_db_setup, contact_factory, name,
                                                     expected1, expected2, expected3, expected4):
    contact = contact_factory(
        name=name,
