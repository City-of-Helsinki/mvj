...
def rr(
    time_spec: str, weekdays: str = "*", tz: str = "Europe/Helsinki"
) -> RecurrenceRule:
    """
...
GET_NEXT_EVENTS_CASES = {
    ...
    "start later": {
        ...
        "result": ["2021-05-01 01:23:00+03:00"],
    },
    ...
    "DST start, Daily: Non-existent as DST ON": {
        ...
        "result": [
            ...
            "2018-03-25 04:30:00+03:00",  # 1:30 UTC
    ...
    "DST starting at midnight: No repetition": {
        "rule": rr("2002 11 01-04 23,0,1 */30", tz="Brazil/East"),
        "start": parse_datetime("2002-01-01 00:00 Z"),
        "result": [
            "2002-11-01 00:00:00-03:00",  # 1st 3:00 UTC
            "2002-11-01 00:30:00-03:00",  # 1st 3:30 UTC
            "2002-11-01 01:00:00-03:00",  # 1st 4:00 UTC
            "2002-11-01 01:30:00-03:00",  # 1st 4:30 UTC
            "2002-11-01 23:00:00-03:00",  # 2nd 2:00 UTC
            "2002-11-01 23:30:00-03:00",  # 2nd 2:30 UTC
            "2002-11-02 00:00:00-03:00",  # 2nd 3:00 UTC
            "2002-11-02 00:30:00-03:00",  # 2nd 3:30 UTC
            "2002-11-02 01:00:00-03:00",  # 2nd 4:00 UTC
            "2002-11-02 01:30:00-03:00",  # 2nd 4:30 UTC
            "2002-11-02 23:00:00-03:00",  # 3rd 2:00 UTC
            "2002-11-02 23:30:00-03:00",  # 3rd 2:30 UTC
            "2002-11-03 01:00:00-02:00",  # 3rd 3:00 UTC
            "2002-11-03 01:30:00-02:00",  # 3rd 3:30 UTC
            "2002-11-03 23:00:00-02:00",  # 4th 1:00 UTC
            "2002-11-03 23:30:00-02:00",  # 4th 1:30 UTC
            "2002-11-04 00:00:00-02:00",  # 4th 2:00 UTC
            "2002-11-04 00:30:00-02:00",  # 4th 2:30 UTC
            "2002-11-04 01:00:00-02:00",  # 4th 3:00 UTC
            "2002-11-04 01:30:00-02:00",  # 4th 3:30 UTC
            "2002-11-04 23:00:00-02:00",  # 5th 1:00 UTC
            "2002-11-04 23:30:00-02:00",  # 5th 1:30 UTC
        ],
    },
    "DST starting at midnight, start from DST change": {
        "rule": rr("2002 11 01-03 23,0,1 */30", tz="Brazil/East"),
        "start": parse_datetime("2002-11-03 00:00:00-03:00"),
        "result": [
            "2002-11-03 01:00:00-02:00",  # 3rd 3:00 UTC
            "2002-11-03 01:30:00-02:00",  # 3rd 3:30 UTC
            "2002-11-03 23:00:00-02:00",  # 4th 1:00 UTC
