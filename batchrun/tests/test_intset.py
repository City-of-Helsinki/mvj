...
@pytest.mark.parametrize(
    "spec", ["*", "1-2", "2-3", "1-9", "1", "2", "1,2,3", "1-1", "1-9/3", "*/42"]
)
...
def test_min_larger_than_max_raises():
    ...
    assert str(excinfo.value) == ("max_value should not be smaller than min_value")
...
@pytest.mark.parametrize(
    "a_spec,a_min,a_max,b_spec,b_min,b_max,expected",
    [
        ("*", 1, 9, "*", 1, 9, True),
        ("*", 1, 9, "1-9", 1, 9, False),
        ("*", 1, 9, "*", 0, 9, False),
