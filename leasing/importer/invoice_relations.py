    ...
    def update_credit_notes(self):
        ...
        for row in rows:
            try:
                ...
                self.stdout.write(
                    "Credited invoice number #{} does not exist".format(row["LASKU"])
                )
                continue
            except Invoice.MultipleObjectsReturned:
                self.stdout.write(
                    "Multiple invoices returned for Credited invoice number #{}!".format(
                        row["LASKU"]
                    )
                )
                continue
            ...
            try:
                ...
                self.stdout.write(
                    "Credit invoice number #{} does not exist".format(
                        row["HYVITYSLASKU"]
                    )
                )
                continue
                ...
                self.stdout.write(
                    "Multiple invoices returned for credit invoice number #{}!".format(
                        row["HYVITYSLASKU"]
                    )
                )
                continue
            ...
            self.stdout.write(
                "{} credits {}".format(credit_note.id, credited_invoice.id)
            )
    ...
    def update_interest_invoices(self):
        ...
        for row in rows:
            try:
                ...
                self.stdout.write(
                    "Invoice number #{} does not exist".format(row["LASKU"])
                )
                continue
            except Invoice.MultipleObjectsReturned:
                self.stdout.write(
                    "Multiple invoices returned for invoice number #{}!".format(
                        row["LASKU"]
                    )
                )
                continue
            ...
            try:
                ...
                self.stdout.write(
                    "Interest invoice number #{} does not exist".format(
                        row["KORKOLASKU"]
                    )
                )
                continue
                ...
                self.stdout.write(
                    "Multiple invoices returned for interest invoice number #{}!".format(
                        row["HYVITYSLASKU"]
                    )
                )
                continue
            ...
            self.stdout.write(
                "{} is an interest invoice for {}".format(
                    interest_invoice.id, invoice.id
                )
            )
