...
from leasing.serializers.land_area import LeaseAreaAttachmentCreateUpdateSerializer, LeaseAreaAttachmentSerializer

from .utils import AtomicTransactionModelViewSet, AuditLogMixin, FileMixin, MultiPartJsonParser


class LeaseAreaAttachmentViewSet(FileMixin, AuditLogMixin, FieldPermissionsViewsetMixin,
