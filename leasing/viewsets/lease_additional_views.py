...
class LeaseCreateCollectionLetterDocumentViewSet(AtomicTransactionMixin, viewsets.GenericViewSet):
    serializer_class = CreateCollectionLetterDocumentSerializer
    permission_classes = (PerMethodPermission,)
    perms_map = {
        'POST': ['leasing.add_collectionletter'],
    }
...
class LeaseSetInvoicingStateView(APIView):
    permission_classes = (PerMethodPermission,)
    perms_map = {
        'POST': ['leasing.change_lease_is_invoicing_enabled'],
    }
...
class LeaseSetRentInfoCompletionStateView(APIView):
    permission_classes = (PerMethodPermission,)
    perms_map = {
        'POST': ['leasing.change_lease_is_rent_info_complete'],
    }
