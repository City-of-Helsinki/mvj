...
class ContractRentPurpose(ConfigurableTextChoice):
    pass


class ContractRentPaymentType(ConfigurableTextChoice):
    pass


class ContractRentBasicRentType(ConfigurableTextChoice):
    pass
...
class ContractRent(models.Model):
    ...
    purpose = models.ForeignKey(
        ContractRentPurpose,
        verbose_name=_("Contract rent purpose"),
        on_delete=models.PROTECT,
    )
    ...
    basic_rent_type = models.ForeignKey(
        ContractRentBasicRentType,
        verbose_name=_("Contract rent basic rent type"),
        on_delete=models.PROTECT,
    )
...
class IndexAdjustedRentPurpose(ConfigurableTextChoice):
    pass
...
class IndexAdjustedRent(models.Model):
    ...
    purpose = models.ForeignKey(
        IndexAdjustedRentPurpose,
        verbose_name=_("Rent purpose"),
        on_delete=models.PROTECT,
    )
...
class RentDiscountPurpose(ConfigurableTextChoice):
    pass
...
class RentDiscount(CommentMixin):
    ...
    discount_purpose = models.ForeignKey(
        RentDiscountPurpose,
        verbose_name=_("Discount purpose"),
        on_delete=models.PROTECT,
    )
...
class RentCriteriaPurpose(ConfigurableTextChoice):
    pass
...
class RentCriteria(models.Model):
    ...
    purpose = models.ForeignKey(
        RentCriteriaPurpose,
        verbose_name=_("Rent criteria purpose"),
        on_delete=models.PROTECT,
    )
