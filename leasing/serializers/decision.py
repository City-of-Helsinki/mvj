...
class ConditionCreateUpdateSerializer(
    FieldPermissionsSerializerMixin, serializers.ModelSerializer
):
    id = serializers.IntegerField(required=False)
    type = InstanceDictPrimaryKeyRelatedField(
        instance_class=ConditionType,
        queryset=ConditionType.objects.filter(),
        related_serializer=ConditionTypeSerializer,
        required=False,
        allow_null=True,
    )
...
class DecisionCreateUpdateNestedSerializer(
    ...
    id = serializers.IntegerField(required=False)
    type = InstanceDictPrimaryKeyRelatedField(
        instance_class=DecisionType,
        queryset=DecisionType.objects.filter(),
        related_serializer=DecisionTypeSerializer,
        required=False,
        allow_null=True,
    )
