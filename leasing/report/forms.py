...
class ReportFormBase(forms.Form):
    ...
    def __init__(self, *args, **kwargs):
        """
        args is expected to contain the query parameters selected in the form
        when the report was requested

        kwargs is expected to contain a key "input_fields" whose value is a
        dictionary containing the names of the query parameters, and the actual
        form field objects they are pointing to.
        """
