...
class ReportOutputSerializer(serializers.Serializer):
    ...
    def __init__(self, *args, output_fields=None, localize_output=False, **kwargs):
        """Initialize the report serializer.

        Args:
            localize_output: format numeric fields into localized strings
        """
    ...
    def get_fields(self):
        ...
        for field_name, field_attrs in self.output_fields.items():
            ...
            if self.localize_output and format_type in [
