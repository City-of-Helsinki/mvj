...
class InvoicePaymentsReport(ReportBase):
    ...
    description = _('Show all the payments that have been paid between the start and the end date')
    ...
    def get_data(self, input_data):
        qs = InvoicePayment.objects.filter(
            ...
            'invoice',
            'invoice__lease', 'invoice__lease__identifier', 'invoice__lease__identifier__type',
            'invoice__lease__identifier__district', 'invoice__lease__identifier__municipality'
        ).order_by('paid_date')
