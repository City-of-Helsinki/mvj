        ...
        for lease in leases:
            ...
            for area in areas:
                ...
                for other_area in other_areas:
                    ...
                    try:
                        intersection = (
                            other_area.geometry & lease_areas[area_identifier].geometry
                        )
                    ...
                    if (
                        other_area.type == AreaType.REAL_PROPERTY
                        or other_area.type == AreaType.UNSEPARATED_PARCEL
                    ):
                        match_data = {
                        ...
                        rest_data = {
                            ...
                            "registration_date": other_area.metadata.get(
                                "registration_date"
                            ),
                        ...
                        if plot_area and plot_area.interarea > 0:
                            ...
                            rest_data = {
                                ...
                                "plot_division_date_of_approval": plot_area.metadata.get(
                                    "date_of_approval"
                                ),
                                "plot_division_effective_date": plot_area.metadata.get(
                                    "effective_date"
                                ),
