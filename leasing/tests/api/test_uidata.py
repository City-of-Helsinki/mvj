...
def test_cant_create_others_uidata(django_db_setup, client, user_factory):
    ...
    data = {"user": user2.id, "key": "testkey", "value": "testvalue"}
...
@pytest.mark.django_db
def test_cant_edit_others_uidata(
    django_db_setup, client, user_factory, ui_data_factory
):
    user = user_factory(username="test_user", email="test_user@example.com")
    user.set_password("test_password")
    user.save()
...
@pytest.mark.django_db
def test_cant_edit_global_uidata(
    django_db_setup, client, user_factory, ui_data_factory
):
    user = user_factory(username="test_user", email="test_user@example.com")
    user.set_password("test_password")
...
@pytest.mark.django_db
def test_cant_delete_others_uidata(
    django_db_setup, client, user_factory, ui_data_factory
):
    user = user_factory(username="test_user", email="test_user@example.com")
    user.set_password("test_password")
