...
def test_create_charge_one_tenant_one_row(
    django_db_setup,
    lease_factory,
    tenant_factory,
...
@pytest.mark.django_db
def test_create_charge_one_tenant_two_rows(
    django_db_setup,
    assert_count_equal,
    lease_factory,
    tenant_factory,
    ...
    data = {
        ...
        "rows": [
            ...
            {"amount": Decimal(20), "receivable_type": 2},
        ],
    }
...
@pytest.mark.django_db
def test_create_charge_three_tenants_one_row(
    django_db_setup,
    assert_count_equal,
    lease_factory,
    tenant_factory,
    ...
    data = {
        "lease": lease.id,
        "due_date": "2019-01-01",
        "rows": [{"amount": Decimal(100), "receivable_type": 1}],
    }
    ...
    assert_count_equal(
        billed_amounts, [Decimal("33.33"), Decimal("33.33"), Decimal("33.34")]
    )
...
@pytest.mark.django_db
def test_create_charge_three_tenants_two_rows(
    django_db_setup,
    assert_count_equal,
    lease_factory,
    tenant_factory,
    ...
    data = {
        ...
        "rows": [
            ...
            {"amount": Decimal(10), "receivable_type": 2},
        ],
    }
