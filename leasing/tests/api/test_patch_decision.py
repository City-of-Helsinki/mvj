...
def test_patch_decision_condition_cannot_change_fields(
    django_db_setup,
    client,
    lease_test_data,
    user_factory,
...
@pytest.mark.django_db
def test_patch_decision_condition_can_change_some_fields(
    django_db_setup,
    client,
    lease_test_data,
    user_factory,
...
def test_patch_decision_remove_decision(
    django_db_setup,
    client,
    lease_test_data,
    user_factory,
