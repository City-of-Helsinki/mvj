...
from leasing.models import Contact, Decision, Inspection, Invoice, Lease, LeaseArea, Tenant
    ...
    def get_field_info(self, field):
        ...
        if isinstance(field, PrimaryKeyRelatedField) or isinstance(field, EnumField):
            ...
            if hasattr(field, 'queryset') and field.queryset.model in (
                    User, Lease, Contact, Decision, Invoice, InvoiceSet, LeaseArea, Tenant, Inspection):
                return field_info
