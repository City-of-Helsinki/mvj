...
def test_get_model_fields_all_fields():
    ...
    model_field_names = [field.name for field in field_permissions.get_model_fields(Dummy)]
    assert model_field_names == ['dummysub', 'id', 'field1', 'field2', 'field3', 'second_sub']
